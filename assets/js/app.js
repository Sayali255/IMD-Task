  ...
  arr.forEach(ele => {
    ...
    <div class="col-md-3">
      <div class="card card-height">
          <figure class="imgFig">
              <img src="${imgUrl}${ele.poster_path}" alt="${ele.title}" title="${ele.title}" class="img-fluid">
          </figure>
        
          <figcaption>
              <div class="row">
                  <div class="col-sm-10">
                      <h5 class="movieTitle p-3">
                      ${ele.title}
                      </h5>
                  </div>
                  <div class="col-sm-2">
                      <div class="${rating(ele.vote_average)} py-3">
                        ${ele.vote_average}
                      </div> 
                  </div>
              </div>
